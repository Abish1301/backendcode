  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert('EquipmentMainInventory', [
      { 
        ...
        dimensions: '15ft x 8ft', weight: '5000kg', color: 'Yellow', status: true, created_at: new Date(), updated_at: new Date(), tax: 2
      },
      { 
        ...
        dimensions: '6ft x 4ft', weight: '300kg', color: 'Orange', status: true, created_at: new Date(), updated_at: new Date(), tax: 2
      },
      { 
        ...
        dimensions: '10ft x 6ft', weight: '3000kg', color: 'Red', status: true, created_at: new Date(), updated_at: new Date(), tax: 2
      },
      { 
        ...
        dimensions: '30ft x 12ft', weight: '8000kg', color: 'Blue', status: true, created_at: new Date(), updated_at: new Date(), tax: 2
      },
      { 
        ...
        dimensions: '20ft x 8ft', weight: '10000kg', color: 'Yellow', status: true, created_at: new Date(), updated_at: new Date(), tax: 2
      },
      { 
        ...
        dimensions: '8ft x 6ft', weight: '2500kg', color: 'Green', status: true, created_at: new Date(), updated_at: new Date(), tax: 2
      },
      { 
        ...
        dimensions: '18ft x 6ft', weight: '4000kg', color: 'Yellow', status: true, created_at: new Date(), updated_at: new Date(), tax: 2
      },
      { 
        ...
        dimensions: '15ft x 7ft', weight: '5000kg', color: 'Blue', status: true, created_at: new Date(), updated_at: new Date(), tax: 2
      },
      { 
        ...
        dimensions: '20ft x 8ft', weight: '8000kg', color: 'White', status: true, created_at: new Date(), updated_at: new Date(), tax: 2
      },
      { 
        ...
        dimensions: '12ft x 6ft', weight: '1000kg', color: 'Orange', status: true, created_at: new Date(), updated_at: new Date(), tax: 2
      },
    ]);
  },
