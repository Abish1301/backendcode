  ...
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert('TaskMaster', [
      ...
      },
      {
        ...
        end_date: '07-12-2024',
        attachement: 'path/seo_guide.pdf',
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
        ...
        end_date: '10-12-2024',
        attachement: 'path/auth_setup.pdf',
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
        ...
        end_date: '15-12-2024',
        attachement: 'path/payment_gateway_plan.pdf',
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
        ...
        end_date: '20-12-2024',
        attachement: 'path/security_enhancement.pdf',
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
        ...
        end_date: '20-12-2024',
        attachement: 'path/cms_setup.pdf',
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
        ...
        end_date: '30-12-2024',
        attachement: 'path/mobile_app_plan.pdf',
        created_at: new Date(),
        updated_at: new Date(),
      },
      {
        ...
        end_date: '22-12-2024',
        attachement: 'path/analytics_setup.pdf',
        created_at: new Date(),
        updated_at: new Date(),
      },
    ]);
